...
class AccountMove(models.Model):
    ...
    def _post(self, soft=True):
        ...
        for move in to_post:
            ...
            # In Italy negative invoices are allowed
            if move.company_id.country_id != self.env.ref('base.it') and move.is_invoice(include_receipts=True) and float_compare(move.amount_total, 0.0, precision_rounding=move.currency_id.rounding) < 0:
